...
export default function HeroText() {
  return (
    <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto py-12">
      ...
      >
        ...
        <span>oitocloud EDGE CLUSTER V2.4</span>
      </div>

      {/* Main Wordmark — Visible by Default */}
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-5">
        <a
          href="/dashboard"
          data-hero-cta
          className="px-8 py-3.5 corner-box bg-gradient-to-r from-brand-500 to-violet-500 text-white font-mono text-xs uppercase tracking-[0.15em] font-semibold hover:shadow-lg hover:shadow-brand-500/20 transition-all duration-300 hover:scale-105 cursor-pointer"
        >
        ...
        <a
          href="/features"
          data-hero-cta
          className="px-8 py-3.5 corner-box glass text-[var(--text-primary)] font-mono text-xs uppercase tracking-[0.15em] hover:bg-white/10 transition-all duration-300 cursor-pointer"
        >
          EXPLORE OUR CLOUD ENGINE
        </a>
      </div>
      ...
      >
        <span className="text-[10px] font-mono tracking-[0.3em] uppercase">
          SCROLL TO UNROLL INFRASTRUCTURE
        </span>
